...
articleView.initNewArticlePage = () => {
  ...
  $('#new-form').on('change', 'input, textarea', articleView.create) // can't invoke articleView.create within this function because we are passing it in as a callback function
};
