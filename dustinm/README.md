...
This portion of the website is to automagically convert HTML and plain-text content into the JSON format used in the main page of the website.

## Getting Started
<!-- What are the steps that a user must take in order to build this app on their own machine and get it running? -->
1. Create a form so writers can enter in their content.
1.5 Create a preview window so writers can see what their content will look like.
1.55 Bind the creation of that preview window to the submit event, or hide it until there is content to show.
2. Create code to JSON stringify the input gathered from the form.
3. Bind this to a submit event, or in our case a change event.

## Architecture
<!-- Provide a detailed description of the application design. What technologies (languages, libraries, etc) you're using, and any other relevant design information. -->
This section of the website uses primarily JQuery, Handlebars and Javascript.

## Change Log
<!-- Use this are to document the iterative changes made to your application as each feature is successfully implemented. Use time stamps. Here's an examples:

01-01-2001 4:59pm - Application now has a fully-functional express server, with GET and POST routes for the book resource. -->
Hint: this part of the markdown is actually broken.

## Credits and Collaborations
<!-- Give credit (and a link) to other people or resources that helped you build this application. -->
Thanks to the Code Fellos Staff for starter code, and the greater coding community for getting us to where we are now globally in software development.
