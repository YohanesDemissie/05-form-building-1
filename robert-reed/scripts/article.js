...
Article.prototype.toHtml = function() {
  ...
  // DONE: Pass the article body into the marked.js library to format our Markdown input
  // QUESTION: I did this in the constructor upon instantiation, is that bad? It seemed like a straightforward way to handle it.
